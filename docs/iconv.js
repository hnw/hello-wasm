...
function integrateWasmJS(Module) {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'iconv.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'iconv.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'iconv.temp.asm.js';
...
STATICTOP = STATIC_BASE + 132288;
/* global initializers */  __ATINIT__.push();


memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "iconv.html.mem" : null;




var STATIC_BUMP = 132288;
        ...
        FS.registerDevice(dev, TTY.stream_ops);
          ...
          if (!tty.input.length) {
            ...
            if (ENVIRONMENT_IS_NODE) {
              ...
              // Browser.
              result = window.prompt('マルチバイト文字を入力してください: ');  // returns null on cancel
              if (result !== null) {
                result += '\n';
              }
...
Module.asmLibraryArg = { "abort": abort, "assert": assert, "enlargeMemory": enlargeMemory, "getTotalMemory": getTotalMemory, "abortOnCannotGrowMemory": abortOnCannotGrowMemory, "abortStackOverflow": abortStackOverflow, "nullFunc_ii": nullFunc_ii, "nullFunc_iiii": nullFunc_iiii, "invoke_ii": invoke_ii, "invoke_iiii": invoke_iiii, "___lock": ___lock, "___syscall6": ___syscall6, "___setErrNo": ___setErrNo, "_abort": _abort, "___syscall140": ___syscall140, "_emscripten_memcpy_big": _emscripten_memcpy_big, "___syscall54": ___syscall54, "___unlock": ___unlock, "___syscall145": ___syscall145, "___syscall146": ___syscall146, "DYNAMICTOP_PTR": DYNAMICTOP_PTR, "tempDoublePtr": tempDoublePtr, "ABORT": ABORT, "STACKTOP": STACKTOP, "STACK_MAX": STACK_MAX };
